...
\begin{frame}{Stage 3 Balanced V1 Checkpoint Selection}
\begin{figure}
\centering
\includegraphics[width=0.86\linewidth]{assets/stage3_v1_eval.png}
\end{figure}
\small
Final checkpoint was selected over step 80: it recovered legal-deal rate and
kept buyer/seller raw rewards reasonably close.
\end{frame}

\begin{frame}{Rollout Comparison on 50 Validation Scenarios}
\begin{figure}
\centering
\includegraphics[width=0.86\linewidth]{assets/rollout_compare.png}
\end{figure}
\small
V1 final remained the best presentation checkpoint: 86\% deal rate, 0\%
format error, 2\% buyer violation, and 8\% seller violation.
\end{frame}

\begin{frame}{Selected V1 Demo Rollout}
\begin{itemize}
    \item Scenario: AirPods Pro 2; buyer budget 1412; seller cost 1034.
    \item Deal price: 1220.
    \item Surplus split: buyer 50.8\%, seller 49.2\%.
    \item Rewards: buyer 56.9, seller 56.0.
\end{itemize}
\begin{figure}
\centering
...
reward, making it clearer than one-sided samples.
\end{frame}
